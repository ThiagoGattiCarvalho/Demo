...
with st.sidebar:
    st.markdown("Only Level 1 Analytics (Descriptive) is available here.")
    st.markdown("Contact Thiago for access to Diagnostic, Predictive and Prescriptive Analytics.")
